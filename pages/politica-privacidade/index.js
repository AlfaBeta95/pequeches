  ...
  return (
    <>
      <CustomFluidContainer>
        ...
        <div>{getPoliticaPrivacidade()}</div>
      </CustomFluidContainer>
      <style jsx>{`
        h1 {
          font-size: 2em;
  ...
  return (
    <>
      <div>
        ...
        <p>TU EMPRESA, S.L., como Responsable del Tratamiento, le informa que, según lo dispuesto en el Reglamento (UE) 2016/679, de 27 de abril, (RGPD) y en la L.O. 3/2018, de 5 de diciembre, de protección de datos y garantía de los derechos digitales (LOPDGDD), trataremos su datos tal y como reflejamos en la presente Política de Privacidad.</p>
      ...
      <div>
        ...
        <p>También tiene derecho a presentar una reclamación ante la Autoridad de control competente (<Link href='https://www.aepd.es'><a target='_blank'>www.aepd.es</a></Link>) si considera que el tratamiento no se ajusta a la normativa vigente.</p>
      </div>
      <div>
